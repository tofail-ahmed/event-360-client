...
const DashBoardService = () => {
  ...
  return (
    <div className=''>
      ...
      {data.map((service) => (
        <div className='bg-green-400/20 p-2  flex mx-[20px] lg:flex-row flex-col-reverse gap-8 my-4' key={service._id}>
          
          <div>
            <img className='w-[250px] h-[250px] mx-auto rounded-lg' src={service.image} alt="" />
          </div>
         <div>
