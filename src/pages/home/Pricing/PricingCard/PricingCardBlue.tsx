import {  FaArrowRight, FaCheck, FaHive } from "react-icons/fa";
const PricingCardBlue = () => {
  return (
    <div className=" bg-white/40 p-5 rounded-md border-t-4  border-[#4e51df] lg:mx-0 mx-14 ">
      <div className="flex justify-between items-center text-4xl font-bold text-[#4e58df]">
        <div className="bg-[#6e4edf49] p-4 rounded-md mb-5 text-md rotate-90">
...
export default PricingCardBlue;
