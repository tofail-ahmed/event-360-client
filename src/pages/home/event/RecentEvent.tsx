        ...
        <div className="flex justify-center items-center lg:flex-row flex-col-reverse">
          ...
          <div className="max-w-[400px] lg:max-w-[520px]">
            ...
            <p className="max-w-[500px] mt-6">
              Latest Event Highlights: Recap the impact! See photos,
              testimonials, and achievements from our recent service event.
              Together, we're creating change and spreading hope. Dive in and be
              inspired!
            </p>
